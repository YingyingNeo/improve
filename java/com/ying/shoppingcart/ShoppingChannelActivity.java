...
public class ShoppingChannelActivity extends AppCompatActivity implements OnClickListener {
    ...
    private void showGoods() {
        ...
        for (; i < goodsArray.size(); i++) {
            ...
            ll_goods.setBackgroundColor(0x16F5A1C0);
            ll_goods.setPadding(20,0,20,20);
            // 添加商品小图
            ImageView iv_thumb = new ImageView(this);
            iv_thumb.setLayoutParams(new LayoutParams(
                    LayoutParams.MATCH_PARENT, 550));
            ...
            tv_price.setLayoutParams(new LayoutParams(0, LayoutParams.WRAP_CONTENT,1 ));
            ...
            btn_add.setLayoutParams(new LayoutParams(0,120,1));
            btn_add.setGravity(Gravity.CENTER);
            btn_add.setText("买它！！");
            btn_add.setTextColor(Color.BLACK);
            btn_add.setBackground(this.getResources().getDrawable(R.drawable.bg_btn_channel));
            ...
            btn_add.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Toast.makeText(ShoppingChannelActivity.this,
                            "小主买了" + info.name + "到购物车哦", Toast.LENGTH_SHORT).show();
                }
            });
